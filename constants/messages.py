...
command_messages = {
    ...
    # TODO повідомлення після успішного видалення контакту
    "delete_contact": "Вибачай, {name}, буду тебе пам'ятати.",
...
command_descriptions = {
    ...
    "update_birthday": "Оновлює день народження (DD.MM.YYYY) для контакту за іменем",
    ...
    "find_birthdays": "Вишукує контакти, день народження яких наступає через вказану кількість днів(по замовченю 7 днів).",
