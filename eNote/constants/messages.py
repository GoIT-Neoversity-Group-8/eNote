...
error_messages = {
    ...
    # при зміні номера не заданий новий номер телефону
    "no_new_phone": "Мені цього замало. Потрібен старий і новий номер?",
    # "no_name_and_phones": "Назви мене, додай телефон для оновлення та новий телефон. Негайно!",
    "find_what": "Мені цього замало. Що саме я маю шукати?",
    ...
    "no_contacts": "У вашій книзі ще немає контактів.",
